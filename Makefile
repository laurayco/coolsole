...
MODULE := bin/py$(PROJECT_NAME)$(SHARED_EXTENSION)
...
CXXFLAGS := -Wall -g -std=c++0x -I$(PYTHON_LOCATION)\include
...
$(MODULE): obj/$(PROJECT_NAME)module.o
	@g++ -shared $^ $(CXXFLAGS) -L$(PYTHON_LOCATION)\libs -l$(PYTHON_VERSION) -o $@
